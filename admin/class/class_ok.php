...
$sql = "INSERT INTO class (name, content, thumbnail, price, level, video, sale_end_date, status, file_table_id) 
 VALUES ('{$name}', '{$content}', '{$thumbnail}', '{$price}', {$level}, '{$video}', '{$sale_end_date}', {$status}, '{$file_table_id}')";
//  var_dump($sql)
