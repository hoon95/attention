...
<div class="common_pd">
      ...
      <div class="d-flex">
        ...
        <ul class="d-flex flex-column justify-content-between">
          <li class="text2 class_bold">강좌명</li>
          <li class="text2 class_bold">난이도</li>
          <li class="text2 class_bold">공개 여부</li>
          <li class="text2 class_bold">수강기한</li>
        </ul>
        <ul class="d-flex flex-column justify-content-between class_m_ml">
          <li class="text2">웹디자이너를 위한 피그마 100% 활용 기초</li>
          <li class="text2 class_level_tag orange">초급</li>
          <li class="text2">공개</li>
          <li class="text2">1개월</li>
        </ul>
      </div>
      <hr>
      <div class="d-flex">
        <ul>
          <li class="text2 class_bold">카테고리</li>
          <li class="text2 class_bold">강좌영상</li>
          <li class="text2 class_bold">강좌소개</li>
        </ul>
        <ul>
          <li class="text2">Computer > Design > 피그마</li>
          <li class="text2">
            <a href="https://www.youtube.com" class="text2 class_sm_pd address_color">https://www.youtube.com</a>
          </li>
          <li class="text2 class_into">입문자를 위해 준비한[프로그래밍 언어] 강의입니다.
