...
<div class="container mt-5">
  ...
  <table class="table mt-5">
    ...
    <tbody>
      ...
      <!-- 대표영상 / 추가이미지 / 교육과정(커리큘럼_아코디언UI)은 하... -->
<?php
if (!empty($rs->video))
{
?>
...
?>
    <tr>
        ...
        <td>
            <img src="/attention/pdata/sclass/<?php echo $file_row["filename"][$i]?>">
        </td>
    </tr>
<?php
    }
...
?>
  ...
  <a href="product_up.php?pid=<?=$pid?>" class="btn btn-primary">수정</a>
  <a href="product_ok.php?mode=del&pid=<?php echo $pid?>" type="button" class="btn btn-danger">삭제</a>
