...
<link rel="stylesheet" href="/attention/user/css/product_whole_list.css">
...
?>
        ...
        <form name="s_form" action="/attention/user/product/product_whole_list.php" id="product_search_form">
...
$(".view-btn").click(function () {
	...
	location.href='product_detail_view.php?pid='+pid;
});
